@if($paginator->count())
    <p class="m-0 text-muted">
        {{
            trans_choice(__('Showing :first_item to :last_item of :total entry|Showing :first_item to :last_item of :total entries',
                ['first_item' =>  $paginator->firstItem(), 'last_item' => $paginator->lastItem(),
